...
fun mapEventDbEntityToNewsItem(entity: EventsEntity): NewsDomainModel {
...
fun mapCategoryApiResponseItemToDbEntity(item: CategoryDomainModel): CategoriesEntity {
...
fun mapCategoryDbEntityToCategoryItem(entity: CategoriesEntity): CategoryDomainModel {
